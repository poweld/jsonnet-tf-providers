{
  ...
  '#with_id':: 'ID of the network zone to retrieve, conflicts with `name`.',
  with_id(value):: (
    local converted = value;
  ...
  '#with_name':: 'Name of the network zone to retrieve, conflicts with `id`.',
  with_name(value):: (
    local converted = value;
  ...
  '#with_usage':: "Zone's purpose: POLICY or BLOCKLIST",
  with_usage(value):: (
    local converted = value;
