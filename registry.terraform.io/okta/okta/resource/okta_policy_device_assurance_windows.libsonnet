{
  ...
  '#with_tpsp_crowd_strike_agent_id':: 'Third party signal provider crowdstrike agent id',
  with_tpsp_crowd_strike_agent_id(value):: (
    local converted = value;
  ...
  '#with_tpsp_crowd_strike_customer_id':: 'Third party signal provider crowdstrike user id',
  with_tpsp_crowd_strike_customer_id(value):: (
    local converted = value;
  ...
  '#with_tpsp_secure_boot_enabled':: 'Third party signal provider secure boot enabled',
  with_tpsp_secure_boot_enabled(value):: (
    local converted = value;
  ...
  '#with_tpsp_third_party_blocking_enabled':: 'Third party signal provider third party blocking enabled',
  with_tpsp_third_party_blocking_enabled(value):: (
    local converted = value;
  ...
  '#with_tpsp_windows_machine_domain':: 'Third party signal provider windows machine domain',
  with_tpsp_windows_machine_domain(value):: (
    local converted = value;
  ...
  '#with_tpsp_windows_user_domain':: 'Third party signal provider windows user domain',
  with_tpsp_windows_user_domain(value):: (
    local converted = value;
