{
  ...
  '#with_auth_url':: 'The URL of the authenticating site for this app.',
  with_auth_url(value):: (
    local converted = value;
  ...
  '#with_url':: 'The URL of the sign-in page for this app.',
  with_url(value):: (
    local converted = value;
  ...
  '#with_user_name_template_push_status':: 'Push username on update. Valid values: `PUSH`, `DONT_PUSH` and `NOT_CONFIGURED`',
  ...
  '#with_user_name_template_type':: 'Username template type. Default: `BUILT_IN`. Valid values: `NONE`, `CUSTOM`, `BUILT_IN`',
