{
  ...
  '#with_role_type':: "Type of the role. Valid values: \t'API_ADMIN', \t'APP_ADMIN', \t'CUSTOM', \t'GROUP_MEMBERSHIP_ADMIN', \t'HELP_DESK_ADMIN', \t'MOBILE_ADMIN', \t'ORG_ADMIN', \t'READ_ONLY_ADMIN', \t'REPORT_ADMIN', \t'SUPER_ADMIN', \t'USER_ADMIN' \t. See [API docs](https://developer.okta.com/docs/reference/api/admin-notifications/#role-types).",
  ...
  '#with_status':: 'Subscription status. Valid values: `subscribed`, `unsubscribed`.',
  with_status(value):: (
    local converted = value;
