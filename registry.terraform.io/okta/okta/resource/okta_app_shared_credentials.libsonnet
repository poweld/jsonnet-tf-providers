{
  ...
  '#with_preconfigured_app':: 'Name of application from the Okta Integration Network, if not included a custom app will be created.',
  ...
  '#with_redirect_url':: 'Secondary URL of the sign-in page for this app',
  ...
  '#with_url_regex':: 'A regular expression that further restricts url to the specified regular expression.',
