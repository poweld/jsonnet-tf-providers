{
  ...
  new(label, password_field, url, username_field):: (
    ...
    + block.with_password_field(password_field)
    + block.with_url(url)
    + block.with_username_field(username_field)
  ),
  ...
  '#with_optional_field1':: 'Name of optional param in the login form',
  with_optional_field1(value):: (
    local converted = value;
  ...
  '#with_optional_field1_value':: 'Name of optional value in login form',
  with_optional_field1_value(value):: (
    local converted = value;
  ...
  '#with_optional_field2':: 'Name of optional param in the login form',
  with_optional_field2(value):: (
    local converted = value;
  ...
  '#with_optional_field2_value':: 'Name of optional value in login form',
  with_optional_field2_value(value):: (
    local converted = value;
  ...
  '#with_optional_field3':: 'Name of optional param in the login form',
  with_optional_field3(value):: (
    local converted = value;
  ...
  '#with_optional_field3_value':: 'Name of optional value in login form',
  with_optional_field3_value(value):: (
    local converted = value;
