{
  ...
  new(audiences, name):: (
    {}
    + block.with_audiences(audiences)
  ...
  '#with_credentials_rotation_mode':: 'The key rotation mode for the authorization server. Can be `AUTO` or `MANUAL`. Default: `AUTO`',
  ...
  '#with_name':: 'The name of the authorization server.',
  with_name(value):: (
    local converted = value;
