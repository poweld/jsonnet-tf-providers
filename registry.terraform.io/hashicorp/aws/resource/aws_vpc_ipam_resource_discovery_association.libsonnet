{
  local block = self,
  new(ipam_id, ipam_resource_discovery_id):: (
    {}
    + block.with_ipam_id(ipam_id)
    + block.with_ipam_resource_discovery_id(ipam_resource_discovery_id)
  ),
  with_arn(value):: (
  ...
  with_ipam_resource_discovery_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"ipam_resource_discovery_id" expected to be of type "string"';
    {
      ipam_resource_discovery_id: converted,
    }
  ),
