{
  ...
  with_spot_bid_status(value):: (
    local converted = value;
    assert std.isString(converted) : '"spot_bid_status" expected to be of type "string"';
    {
      spot_bid_status: converted,
    }
  ),
  with_spot_instance_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"spot_instance_id" expected to be of type "string"';
    {
      spot_instance_id: converted,
    }
  ),
