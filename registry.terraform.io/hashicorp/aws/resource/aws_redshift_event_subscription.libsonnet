{
  ...
  with_customer_aws_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"customer_aws_id" expected to be of type "string"';
    {
      customer_aws_id: converted,
    }
  ),
  with_enabled(value):: (
    local converted = value;
