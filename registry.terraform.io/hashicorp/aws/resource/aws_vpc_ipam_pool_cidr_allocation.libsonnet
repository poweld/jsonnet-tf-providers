{
  ...
  with_ipam_pool_allocation_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"ipam_pool_allocation_id" expected to be of type "string"';
    {
      ipam_pool_allocation_id: converted,
    }
  ),
