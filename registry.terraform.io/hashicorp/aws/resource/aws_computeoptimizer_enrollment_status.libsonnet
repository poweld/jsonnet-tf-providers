{
  ...
  with_include_member_accounts(value):: (
    local converted = value;
  ...
  with_number_of_member_accounts_opted_in(value):: (
    local converted = value;
    assert std.isNumber(converted) : '"number_of_member_accounts_opted_in" expected to be of type "number"';
    {
      number_of_member_accounts_opted_in: converted,
    }
  ),
