{
  local block = self,
  new(prefix_list_id, transit_gateway_route_table_id):: (
    {}
  ...
  with_prefix_list_owner_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"prefix_list_owner_id" expected to be of type "string"';
    {
      prefix_list_owner_id: converted,
    }
  ),
