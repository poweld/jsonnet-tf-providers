{
  local block = self,
  new(internet_gateway_block_mode):: (
    {}
    + block.with_internet_gateway_block_mode(internet_gateway_block_mode)
  ),
  ...
  with_internet_gateway_block_mode(value):: (
    local converted = value;
    assert std.isString(converted) : '"internet_gateway_block_mode" expected to be of type "string"';
    {
      internet_gateway_block_mode: converted,
    }
  ),
