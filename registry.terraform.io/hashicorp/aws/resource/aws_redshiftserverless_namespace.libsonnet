{
  ...
  with_admin_password_secret_arn(value):: (
    local converted = value;
    assert std.isString(converted) : '"admin_password_secret_arn" expected to be of type "string"';
    {
      admin_password_secret_arn: converted,
    }
  ),
  with_admin_password_secret_kms_key_id(value):: (
    local converted = value;
  ...
  with_admin_user_password_wo(value):: (
    local converted = value;
  ...
  with_admin_user_password_wo_version(value):: (
    local converted = value;
  ...
  with_manage_admin_password(value):: (
    local converted = value;
