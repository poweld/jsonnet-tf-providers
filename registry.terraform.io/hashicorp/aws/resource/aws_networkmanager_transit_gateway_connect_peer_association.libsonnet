{
  local block = self,
  new(device_id, global_network_id, transit_gateway_connect_peer_arn):: (
    {}
    + block.with_device_id(device_id)
    + block.with_global_network_id(global_network_id)
    + block.with_transit_gateway_connect_peer_arn(transit_gateway_connect_peer_arn)
  ),
  ...
  with_transit_gateway_connect_peer_arn(value):: (
    local converted = value;
