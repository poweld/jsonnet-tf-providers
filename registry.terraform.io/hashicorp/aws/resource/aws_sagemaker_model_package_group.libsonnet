{
  local block = self,
  new(model_package_group_name):: (
    {}
    + block.with_model_package_group_name(model_package_group_name)
  ),
  with_arn(value):: (
  ...
  with_model_package_group_description(value):: (
    local converted = value;
  ...
  with_model_package_group_name(value):: (
    local converted = value;
