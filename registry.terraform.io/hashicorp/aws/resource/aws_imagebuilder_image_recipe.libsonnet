{
  ...
  systems_manager_agent:: {
    local block = self,
    new(uninstall_after_build):: (
      {}
      + block.with_uninstall_after_build(uninstall_after_build)
    ),
    with_uninstall_after_build(value):: (
      local converted = value;
  ...
  with_systems_manager_agent(value):: (
    local converted = if std.isArray(value) then value else [value];
    {
  ...
  with_systems_manager_agent_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    {
