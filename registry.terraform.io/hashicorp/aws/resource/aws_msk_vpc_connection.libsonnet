{
  local block = self,
  new(authentication, client_subnets, security_groups, target_cluster_arn, vpc_id):: (
    {}
    ...
    + block.with_target_cluster_arn(target_cluster_arn)
