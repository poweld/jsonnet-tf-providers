{
  ...
  with_dashboard_endpoint_v2(value):: (
    local converted = value;
    assert std.isString(converted) : '"dashboard_endpoint_v2" expected to be of type "string"';
    {
      dashboard_endpoint_v2: converted,
    }
  ),
  with_domain_endpoint_v2_hosted_zone_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"domain_endpoint_v2_hosted_zone_id" expected to be of type "string"';
    {
      domain_endpoint_v2_hosted_zone_id: converted,
    }
  ),
  ...
  with_endpoint_v2(value):: (
    local converted = value;
    assert std.isString(converted) : '"endpoint_v2" expected to be of type "string"';
    {
      endpoint_v2: converted,
    }
  ),
  ...
  advanced_security_options:: {
    ...
    with_anonymous_auth_enabled(value):: (
      local converted = value;
  ...
  auto_tune_options:: {
    ...
    with_use_off_peak_window(value):: (
      local converted = value;
  ...
  cluster_config:: {
    ...
    with_multi_az_with_standby_enabled(value):: (
      local converted = value;
    ...
    node_options:: {
      ...
      with_node_config(value):: (
        local converted = if std.isArray(value) then value else [value];
        {
          node_config: value,
        }
      ),
      with_node_config_mixin(value):: (
        local converted = if std.isArray(value) then value else [value];
        {
  ...
  off_peak_window_options:: {
    ...
    off_peak_window:: {
      ...
      with_window_start_time(value):: (
        local converted = if std.isArray(value) then value else [value];
        {
          window_start_time: value,
        }
      ),
      with_window_start_time_mixin(value):: (
        local converted = if std.isArray(value) then value else [value];
        {
    ...
    with_off_peak_window(value):: (
      local converted = if std.isArray(value) then value else [value];
      {
        off_peak_window: value,
      }
    ),
    with_off_peak_window_mixin(value):: (
      local converted = if std.isArray(value) then value else [value];
      {
  ...
  software_update_options:: {
    ...
    with_auto_software_update_enabled(value):: (
      local converted = value;
  ...
  with_off_peak_window_options(value):: (
    local converted = if std.isArray(value) then value else [value];
    {
  ...
  with_software_update_options(value):: (
    local converted = if std.isArray(value) then value else [value];
    {
  ...
  with_off_peak_window_options_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    {
  ...
  with_software_update_options_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    {
