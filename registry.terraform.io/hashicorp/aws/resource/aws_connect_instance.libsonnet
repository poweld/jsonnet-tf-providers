{
  local block = self,
  new(identity_management_type, inbound_calls_enabled, outbound_calls_enabled):: (
    {}
    + block.with_identity_management_type(identity_management_type)
    + block.with_inbound_calls_enabled(inbound_calls_enabled)
    + block.with_outbound_calls_enabled(outbound_calls_enabled)
  ),
  with_arn(value):: (
