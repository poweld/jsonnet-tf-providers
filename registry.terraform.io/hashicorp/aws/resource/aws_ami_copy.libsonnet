{
  local block = self,
  new(name, source_ami_id, source_ami_region):: (
    {}
    + block.with_name(name)
    + block.with_source_ami_id(source_ami_id)
    + block.with_source_ami_region(source_ami_region)
  ),
  ...
  with_destination_outpost_arn(value):: (
    local converted = value;
