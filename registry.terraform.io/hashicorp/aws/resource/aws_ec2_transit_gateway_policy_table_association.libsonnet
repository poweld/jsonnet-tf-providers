{
  local block = self,
  new(transit_gateway_attachment_id, transit_gateway_policy_table_id):: (
    {}
    + block.with_transit_gateway_attachment_id(transit_gateway_attachment_id)
    + block.with_transit_gateway_policy_table_id(transit_gateway_policy_table_id)
  ),
  with_id(value):: (
  ...
  with_transit_gateway_policy_table_id(value):: (
    local converted = value;
