{
  local block = self,
  new(aws_account_id, network_interface_id, permission):: (
    {}
    + block.with_aws_account_id(aws_account_id)
  ...
  with_network_interface_permission_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"network_interface_permission_id" expected to be of type "string"';
    {
      network_interface_permission_id: converted,
    }
  ),
