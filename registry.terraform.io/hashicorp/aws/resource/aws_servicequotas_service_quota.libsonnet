{
  ...
  with_request_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"request_id" expected to be of type "string"';
    {
      request_id: converted,
    }
  ),
  with_request_status(value):: (
    local converted = value;
    assert std.isString(converted) : '"request_status" expected to be of type "string"';
    {
