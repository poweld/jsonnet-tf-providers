{
  local block = self,
  new(migration_type, replication_instance_arn, replication_task_id, source_endpoint_arn, table_mappings, target_endpoint_arn):: (
    {}
    + block.with_migration_type(migration_type)
    + block.with_replication_instance_arn(replication_instance_arn)
