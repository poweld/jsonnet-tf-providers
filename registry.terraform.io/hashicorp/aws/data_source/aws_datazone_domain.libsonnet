{
  ...
  with_managed_account_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"managed_account_id" expected to be of type "string"';
    {
      managed_account_id: converted,
    }
  ),
  with_name(value):: (
    local converted = value;
