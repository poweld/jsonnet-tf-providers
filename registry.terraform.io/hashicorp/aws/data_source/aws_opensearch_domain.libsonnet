{
  ...
  with_software_update_options(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"software_update_options" expected to be of type "list"';
    {
  ...
  off_peak_window_options:: {
    ...
    with_off_peak_window(value):: (
      local converted = if std.isArray(value) then value else [value];
      assert std.isArray(converted) : '"off_peak_window" expected to be of type "list"';
      {
