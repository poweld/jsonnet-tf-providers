{
  ...
  with_create_database_default_permissions(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"create_database_default_permissions" expected to be of type "list"';
    {
  ...
  with_create_table_default_permissions(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"create_table_default_permissions" expected to be of type "list"';
    {
