{
  ...
  '#with_created_date':: 'The date the security policy was created.',
  ...
  '#with_description':: 'Description of the security policy.',
  ...
  '#with_last_modified_date':: 'The date the security policy was last modified.',
  ...
  '#with_policy':: 'The JSON policy document without any whitespaces.',
  with_policy(value):: (
    local converted = value;
  ...
  '#with_type':: 'Type of security policy. One of `encryption` or `network`.',
  with_type(value):: (
    local converted = value;
