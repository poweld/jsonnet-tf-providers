{
  local block = self,
  new(index_id, query_suggestions_block_list_id):: (
    {}
    + block.with_index_id(index_id)
    + block.with_query_suggestions_block_list_id(query_suggestions_block_list_id)
  ),
  with_arn(value):: (
  ...
  with_query_suggestions_block_list_id(value):: (
    local converted = value;
