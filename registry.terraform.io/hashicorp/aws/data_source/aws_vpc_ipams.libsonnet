{
  ...
  with_ipam_ids(value):: (
    ...
    assert std.isArray(converted) : '"ipam_ids" expected to be of type "list"';
    {
      ipam_ids: converted,
    }
  ),
  with_ipam_ids_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"ipam_ids" expected to be of type "list"';
    {
      ipam_ids+: converted,
  ...
  with_ipams(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"ipams" expected to be of type "list"';
    {
      ipams: converted,
    }
  ),
  with_ipams_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"ipams" expected to be of type "list"';
    {
      ipams+: converted,
