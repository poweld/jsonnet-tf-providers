{
  ...
  with_transit_gateway_connect_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"transit_gateway_connect_id" expected to be of type "string"';
    {
      transit_gateway_connect_id: converted,
    }
  ),
