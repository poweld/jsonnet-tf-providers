{
  ...
  with_organization_resource_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"organization_resource_id" expected to be of type "string"';
    {
      organization_resource_id: converted,
    }
  ),
  ...
  with_security_profile_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"security_profile_id" expected to be of type "string"';
    {
      security_profile_id: converted,
    }
  ),
  with_tags(value):: (
    local converted = value;
