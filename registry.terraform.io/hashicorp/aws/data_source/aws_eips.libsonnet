{
  ...
  with_allocation_ids(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"allocation_ids" expected to be of type "list"';
    {
      allocation_ids: converted,
    }
  ),
  with_allocation_ids_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"allocation_ids" expected to be of type "list"';
    {
      allocation_ids+: converted,
