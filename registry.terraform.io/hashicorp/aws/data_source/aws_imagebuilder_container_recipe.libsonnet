{
  ...
  with_instance_configuration(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"instance_configuration" expected to be of type "list"';
    {
  ...
  with_target_repository(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"target_repository" expected to be of type "list"';
    {
