{
  ...
  with_attachments(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"attachments" expected to be of type "list"';
    {
      attachments: converted,
    }
  ),
  with_attachments_mixin(value):: (
    local converted = if std.isArray(value) then value else [value];
    assert std.isArray(converted) : '"attachments" expected to be of type "list"';
    {
      attachments+: converted,
  ...
  with_internet_gateway_id(value):: (
    local converted = value;
    assert std.isString(converted) : '"internet_gateway_id" expected to be of type "string"';
    {
      internet_gateway_id: converted,
    }
  ),
  with_owner_id(value):: (
    local converted = value;
